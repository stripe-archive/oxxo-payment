...
$app->get('/payment-intent', function (Request $request, Response $response, array $args) {   
  // Display order completed page
  $payment_intent_id = $request->getQueryParam('paymentIntentId');
